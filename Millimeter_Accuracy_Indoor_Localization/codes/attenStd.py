...
fpath_positions = f"/lustre/home/br-lqiao/CSI-Posi/dataset/URA_lab_LoS_UP.npy"
fpath_train = f"/lustre/home/br-lqiao/CSI-Posi/dataset/URA_lab_LoS_CSI.npy"
...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, key_size, query_size, value_size,
        ...
        # self.dense = nn.Linear(64 * 100 * 6, 2)
...
class EncoderDecoder(nn.Module):
    ...
    def __init__(self, encoder, decoder, **kwargs):
        ...
        self.dense1 = nn.Linear(64 * 100 * 6, 2048)
        self.relu1 = nn.LeakyReLU()
        self.dense2 = nn.Linear(2048, 1024)
        self.relu2 = nn.LeakyReLU()
        self.dense3 = nn.Linear(1024, 2)
    ...
    def forward(self, X, *args):
        ...
        X = self.relu1(self.dense1(X.view([X.shape[0], -1])))
...
np.save('/lustre/home/br-lqiao/CSI-Posi/result/attenStd.npy', diserr.cpu().numpy())
